  ...
  return (
    <main className="w-full h-full">
      ...
      <section className="h-screen w-full bg-neutral-950 rounded-md relative flex flex-col items-center antialiased overflow-visible">
        ...
        <div className="flex flex-col mt-[-20vh] md:mt-[-10vh]">
          <ContainerScroll
            titleComponent={
      ...
      <section className="mt-[-25vh]">
        <LampComponent />
        <div className="flex flex-wrap items-center justify-center flex-col md:flex-row gap-8 mb-12">
